...
public class WiringConstants {
  ...
  public static class SwerveWiring {
    ...
    public static final int FRONT_LEFT_ANGLE_ID = 4;
    public static final int FRONT_RIGHT_DRIVE_ID = 8;
    public static final int FRONT_RIGHT_ANGLE_ID = 1;
    ...
    public static final int BACK_RIGHT_ENCODER_ID = 9;
    //the values are the port numbers
  }
}
